    ...
    const handleData = async () => {
      try {
        ...
        const nonFriends = allUsers.filter(
          (user: User) =>
            !myFriends.includes(user.name) && user.name !== myProfile.name
        );
