      ...
      <div className={style.sidebar}>
        ...
        <div className={style.btn__container}>
          <Nav defaultActiveKey="/home" className={style.nav__bar}>
            <Link
              to="/home"
              className={pathname === "/home" ? style.activeLink : ""}
            >
            ...
            <Link
              ...
              className={
                pathname === "/users-list/society" ? style.activeLink : ""
              }
            >
            ...
            <Link
              to="/reels"
              className={pathname === "/feels" ? style.activeLink : ""}
            >
            ...
            <Link
              to="/my-profile"
              className={pathname === "/my-profile" ? style.activeLink : ""}
            >
            ...
            <Link
              to="/message"
              className={pathname === "/message" ? style.activeLink : ""}
            >
            ...
            <Link
              to="/game"
              className={pathname.startsWith("/game") ? style.activeLink : ""}
            >
            ...
            <Link
              to="/about-product"
              className={pathname === "/about-product" ? style.activeLink : ""}
            >
